...
using zense::ImageRequest;
using zense::ImageRGBDIRReply;
using zense::ImageRGBDReply;
...
int main(int argc, char **argv) {
  ...
  PicoZenseAsyncServer server;
  server.Setup(cfgParamPath, camKey, device_index);
  server.Run();
  return 0;
}
